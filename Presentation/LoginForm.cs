    ...
    public partial class FmrLogin : Form
    {
        ...
        {//Iniciar sesión
            ...
            if (userModel != null)//Si el inicio de sesión fue exitosa.
            {
                ...
                if (ActiveUser.Position == Positions.Administrador || ActiveUser.Position == Positions.Bedel || ActiveUser.Position == Positions.Profesor)
                {
                ...
                //else if (ActiveUser.Position == Positions.Profesor)
                //{
                ...
                var welcomeForm = new FmrInicio(userModel.FullName);//Mostrar el formulario de bienvenida.
